...
{
    // Locked windows cannot be floated (they must stay at their tree position)
    if (!state->isFloating(windowId) && m_windowTracker && m_windowTracker->isWindowLocked(windowId)) {
