                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                AlgorithmPreview {
                                    ...
                                    splitRatio: root.effectiveAlgorithm === "centered-master" ? root.settingValue("SplitRatio", root.kcmModule.autotileCenteredMasterSplitRatio) : root.settingValue("SplitRatio", root.kcmModule.autotileSplitRatio)
                                    masterCount: root.effectiveAlgorithm === "centered-master" ? root.settingValue("MasterCount", root.kcmModule.autotileCenteredMasterMasterCount) : root.settingValue("MasterCount", root.kcmModule.autotileMasterCount)
                                }
